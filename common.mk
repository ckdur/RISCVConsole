...
NUMA_PREFIX = $(if $(filter $(NUMACTL),0),,$(shell $(base_dir)/hardware/chipyard/scripts/numa_prefix))
...
#########################################################################################
include $(base_dir)/hardware/chipyard/generators/cva6/cva6.mk
include $(base_dir)/hardware/chipyard/generators/ibex/ibex.mk
...
include $(base_dir)/hardware/chipyard/tools/torture.mk
...
CHECK_SUBMODULES_COMMAND = echo "Checking all submodules in generators/ are initialized. Uninitialized submodules will be displayed" ; ! git submodule status $(base_dir)/hardware/chipyard/generators | grep ^-
...
SBT_SOURCE_DIRS = $(addprefix $(base_dir)/hardware/chipyard/,generators sims/firesim/sim tools)
...
$(TOP_SMEMS_CONF) $(MODEL_SMEMS_CONF) &:  $(MFC_SMEMS_CONF) $(MFC_MODEL_HRCHY_JSON_UNIQUIFIED)
	$(base_dir)/hardware/chipyard/scripts/split-mems-conf.py \
