...
SOURCE_DIRS = $(addprefix $(base_dir)/hardware/chipyard/,generators sims/firesim/sim tools/barstools/iocell)
...
#########################################################################################
$(sim_files): $(call lookup_srcs,$(base_dir)/hardware/chipyard/generators/utilities/src/main/scala,scala) $(FIRRTL_JAR)
