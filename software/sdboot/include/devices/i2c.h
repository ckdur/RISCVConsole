...
#define I2C_REG_PRESCALE_LOW    0x00
#define I2C_REG_PRESCALE_HIGH   0x04
#define I2C_REG_CONTROL         0x08
#define I2C_REG_TRANSMIT        0x0c
#define I2C_REG_COMMAND         0x10
#define I2C_REG_STATUS          0x10
